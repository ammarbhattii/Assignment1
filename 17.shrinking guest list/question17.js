...
var Frind = ["Awais", "Ali", "Haider", "Umar", "Ashar"];
...
while (Frind.length > 2) {
    var removedPerson = Frind.pop();
    if (removedPerson) {
        console.log("sorry ".concat(removedPerson, " i cant invite you to the dinner."));
    }
}
// // // Print a message to each of the two people still on your list, letting them know they’re still invited.
for (var _i = 0, Frind_1 = Frind; _i < Frind_1.length; _i++) {
    var person = Frind_1[_i];
    console.log("".concat(person, " you are still invited to the dinner"));
}
